...
{
  const bool custom = (tms9918->registers[TMS_REG_0] & TMS_R0_MODE_CUSTOM) != 0;
...
/* Function:  vrEmuTms9918WriteVramValue
 * ----------------------------------------
